import { StyleSheet, Text, View, TouchableOpacity, Image, ScrollView, KeyboardAvoidingView, TextInput} from 'react-native'
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={{width: '100%',}}>
                <View style={{flexDirection: 'row', marginHorizontal: 10, justifyContent: 'space-between', alignItems: 'center', marginBottom: 30}}>
            ...
            <View style={{position: 'absolute', alignItems: 'center', justifyContent: 'center', bottom: 120, alignItems: 'flex-end', width: '100%' }}>
